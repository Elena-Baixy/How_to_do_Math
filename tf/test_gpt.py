...
tokenizer = GPT2Tokenizer.from_pretrained("gpt2-large") #change the model
model = GPT2ForSequenceClassification.from_pretrained("gpt2-large", activation_function="relu") #change the model
print(model)
